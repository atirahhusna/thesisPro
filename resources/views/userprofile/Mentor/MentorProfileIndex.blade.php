...
@endif
      ...
      <div class="profile-field">
        ...
        <input type="text" id="name" name="name" value="{{ $data->m_name }}" readonly>
      </div>

      <div class="profile-field">
        <label for="gender">Email</label>
        <input type="text" id="gender" name="s_email" value="{{ $data->m_email }}" readonly>
      </div>

      <div class="profile-field">
        <label for="religion">Education</label>
        <input type="text" id="address" name="s_address" value="{{ $data->m_education_level }}" readonly>
      </div>

      <div class="profile-field">
        <label for="phone">Phone Number</label>
        <input type="text" id="phone" name="s_phone_number" value="{{ $data->m_phone_number }}" readonly>
      </div>

      <div class="profile-field">
        <label for="phone">Experience</label>
        <input type="text" id="phone" name="s_phone_number" value="{{ $data->m_experience}}" readonly>
      </div>

      <div class="profile-field">
        <label for="phone">Postion </label>
        <input type="text" id="phone" name="s_phone_number" value="{{ $data->m_position }}" readonly>
      </div>
    ...
    <a href="{{ url('MentorProfile/'.$data->mentor_id.'/edit') }}"  class="edit-btn">Edit</a>
