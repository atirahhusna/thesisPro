  ...
  <div class="profile-view">
    ...
    <form id="profileForm" action="{{ url('platinumProfile/update') }}" method="post" class="profile-form">
      ...
      <div class="profile-field">
        ...
        <input type="text" id="name" name="name" value="{{ $data->r_name }}" >
      </div>

      <div class="profile-field">
        <label for="gender">Gender</label>
        <input type="text" id="gender" name="r_gender" value="{{ $data->r_gender }}" >
      </div>

      <div class="profile-field">
        <label for="religion">Religion</label>
        <input type="text" id="religion" name="r_religion" value="{{ $data->r_religion }}" >
      </div>

      <div class="profile-field">
        <label for="phone">Phone</label>
        <input type="text" id="phone" name="r_phone_number" value="{{ $data->r_phone_number }}" >
      </div>

      <div class="profile-field">
        <label for="facebook">Facebook</label>
        <input type="text" id="facebook" name="r_facebook" value="{{ $data->r_facebook }}" >
      </div>

      <div class="profile-field">
        <label for="university">University</label>
        <input type="text" id="university" name="r_edu_institute" value="{{ $data->r_edu_institute }}" >
      </div>
