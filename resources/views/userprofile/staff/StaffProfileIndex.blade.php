...
@endif
      ...
      <div class="profile-field">
        ...
        <input type="text" id="name" name="name" value="{{ $data->s_name }}" readonly>
      </div>

      <div class="profile-field">
        <label for="gender">Email</label>
        <input type="text" id="gender" name="s_email" value="{{ $data->s_email }}" readonly>
      </div>
    ...
    <a href="{{ url('StaffProfile/'.$data->staff_id.'/edit') }}"  class="edit-btn">Edit</a>
